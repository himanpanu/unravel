    ...
    <div className='font-["Arial"]'>
        ...
        <div className='flex flex-row w-full px-32 justify-center space-x-10 mb-20 mt-10'>
            <div className='w-1/2 flex flex-col text-sm'>
                ...
                <input id="bName" className='mb-3 border-2 rounded-md p-1' placeholder='Business Name'/>
                <label for="address1" className='font-bold'>Address 1</label>
                <input id="address1" className='mb-3 border-2 rounded-md p-1' placeholder='Enter Address 1'/>
                <label for="address2" className='font-bold' >Address2</label>
                <input id="address2" className='mb-3 border-2 rounded-md p-1' placeholder='Enter Address 2'/>
                <div className='flex flex-row space-x-3'>
                <div className='flex flex-col'>
                <label for="city" className='font-bold'>City</label>
                <input id="city" placeholder='City' className='border-2 rounded-md p-1'/>
                </div>
                <div className='flex flex-col mb-3'>
                <label for="state" className='font-bold'>State</label>
                <input id="state" placeholder='State' className='border-2 rounded-md p-1'/>
                </div>
                <div className='flex flex-col'>
                <label for="zip" className='font-bold'>Zip</label>
                <input id="zip" placeholder='Zip' className='border-2 rounded-md p-1'/>
                </div>
                </div>
                <label for="phone" className='font-bold'>Phone</label>
                <input placeholder='Phone' className='mb-3 border-2 rounded-md p-1' id="phone"/>
                <label for="website" className='font-bold'>Website</label>
                <input placeholder="Website" className='mb-3 border-2 rounded-md p-1' id="website"/>
                <label for="Hours" className='font-bold'>Hours</label>
                <input id="hours" className='mb-3 border-2 rounded-md p-1' placeholder='hours'/>
                <label for="categories" className='font-bold'>Categories</label>
                <input id="categories" className='mb-3 border-2 rounded-md p-1' placeholder='Categories'/>
                <label for="email" className='font-bold'>Email ID</label>
                <input id='email' type='email' className='mb-6 border-2 rounded-md p-1'placeholder='Email ID'/>
